...
<div class="container py-md-5 container--narrow">
    ...
    <form action="/create-task" method="POST">
      ...
      <div class="form-group">
        ...
        <input value="<?php echo e(old('title')); ?>" required name="title" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="" autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <textarea name="body" id="post-body" class="body-content tall-textarea form-control" type="text"><?php echo e(old('body')); ?></textarea>
...
</body><?php /**PATH C:\multi-2722024\resources\views/auth\add-task-form.blade.php ENDPATH**/ ?>